...
;( function( $ ) {
	...
	var ts = $.tablesorter = {
		...
		*/
		...
		//put current order to variable add by finira 2016/5/5
		putCurrentOrder:function(sortList) {
			if(sortList&&sortList.length){
				ts.currentSortOrder  = {'0':'asc','1':'desc','2':'unsort'}[sortList[ 0 ][ 1 ]]||'';
			}
		},
		//return current order  add by finira 2016/5/5
		getCurrentOrder:function() {
			return ts.currentSortOrder;
		},
